...
import { substitute, substituteShell, evalWhen, resolveHeader, resolveButtonCommand, headerHasPrButton } from "../../../server/config/header-resolve";
import type { HeaderConfig, HeaderContext } from "../../../server/config/header-config";
