...
import { substitute, substituteShell, evalWhen, resolveHeader, resolveButtonCommand, headerHasPrButton } from "../../../server/config/../../server/config/header-resolve.js";
import type { HeaderConfig, HeaderContext } from "../../../server/config/../../server/config/header-config.js";
