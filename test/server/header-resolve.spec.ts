...
import { substitute, substituteShell, evalWhen, resolveHeader, resolveButtonCommand, headerHasPrButton } from "../../server/header-resolve.js";
import type { HeaderConfig, HeaderContext } from "../../server/header-config.js";
