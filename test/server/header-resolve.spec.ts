...
import { substitute, substituteShell, evalWhen, resolveHeader, resolveButtonCommand, headerHasPrButton } from "../../server/../server/header-resolve.js";
import type { HeaderConfig, HeaderContext } from "../../server/../server/header-config.js";
