...
<style>
  ...
  :root {
    --hue: 25;                                    /* red - a page that moves while you watch */
  ...
  h2 { margin: 22px 0 8px; font-size: 17px; letter-spacing: -.02em; }
  #waiting, #voteArea, #votedArea { padding: 16px 18px; border: 1px solid var(--line); border-radius: 16px; background: var(--fill); }
  #opts label { display: flex; align-items: center; gap: 9px; margin: 8px 0 0; color: var(--ink); font-size: 15px; font-weight: 400; cursor: pointer; }
  #tally > p, #list > p { display: flex; flex-wrap: wrap; align-items: center; gap: 8px 12px; margin: 0 0 8px; padding: 13px 15px; border: 1px solid var(--line); border-radius: 14px; background: var(--fill); }
  #notice, #say, #lede { min-height: 1.6em; margin: 14px 0 0; color: var(--main); font-size: 13px; font-weight: 700; }
</style>
<h1>Live poll</h1>
