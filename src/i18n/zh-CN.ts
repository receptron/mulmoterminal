...
export const zhCN: Messages = {
  settings: {
    ...
    surviving: {
      ...
      doomed: "下次启动时结束",
      doomedTitle: "没有任何东西在用它，而且已经安静了 {days} 天 —— 服务器下次启动时会结束它",
      doomedSoon: "下次清扫时结束",
      doomedSoonTitle: "没有任何东西在用它，而且已经安静了 {days} 天 —— 这台服务器每 {hours} 小时清扫一次，所以不用等重启就会结束它",
      open: "● 使用中",
      ...
      sweepUnit: "小时",
      sweepHint: "这台服务器正在每 {hours} 小时重复一次。",
      sweepOffTitle: "只在服务器启动时运行。",
      sweepOffHint: "一直开着的服务器之后就再也不会去看了 —— 想让它重复就把这个调大。",
      sweepDisabledHint: "上面的清扫本身是关掉的，所以这里没有可重复的东西。",
      sweepPendingTitle: "已保存 —— 从下次服务器启动起开始重复。",
      sweepPendingRunning: "在那之前，这台服务器仍每 {hours} 小时清扫一次。",
      sweepPendingIdle: "在那之前，这台服务器只在启动时清扫。",
      neverTitle: "永不自动结束。",
      neverHint: "它们会一直留着，直到你在这里停掉，或者从占着它的终端里结束它。",
      reapHint: "没有任何东西在用 —— 没人连接、这么久没有输出 —— 的会话{ended}。它的对话会保留。设为 0 就永不自动结束。",
      reapEnded: "会在服务器下次启动时结束",
      reapEndedSweep: "会在下次清扫时结束",
    },
