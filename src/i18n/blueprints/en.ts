...
export const blueprintsEn = {
  ...
  spec: {
    ...
    empty: "No conversation yet. Write what to change, add or ask — the agent edits the spec and replies.",
    you: "You",
    agent: "Agent",
    placeholder: 'What to change, add or ask (e.g. "let me delete books too")',
    send: "Send",
    sendHint: "⌘/Ctrl + Enter to send",
    revising: "Revising the specification…",
    missing: "There is no specification yet.",
