...
export const en = {
  settings: {
    ...
    toolbarPins: {
      ...
      loadFailed:
        "Could not read what you have pinned ({error}), so there is nothing to offer here yet. The toolbar keeps whatever it was already showing; reopen this after the connection is back.",
