...
export const zhTW: Messages = {
  settings: {
    ...
    surviving: {
      ...
      doomed: "下次啟動時結束",
      doomedTitle: "沒有任何東西在用它，而且已經安靜了 {days} 天 —— 伺服器下次啟動時會結束它",
      doomedSoon: "下次清掃時結束",
      doomedSoonTitle: "沒有任何東西在用它，而且已經安靜了 {days} 天 —— 這台伺服器每 {hours} 小時清掃一次，所以不用等重啟就會結束它",
      open: "● 使用中",
      ...
      sweepUnit: "小時",
      sweepHint: "這台伺服器正在每 {hours} 小時重複一次。",
      sweepOffTitle: "只在伺服器啟動時執行。",
      sweepOffHint: "一直開著的伺服器之後就再也不會去看了 —— 想讓它重複就把這個調大。",
      sweepDisabledHint: "上面的清掃本身是關掉的，所以這裡沒有可重複的東西。",
      sweepPendingTitle: "已儲存 —— 從下次伺服器啟動起開始重複。",
      sweepPendingRunning: "在那之前，這台伺服器仍每 {hours} 小時清掃一次。",
      sweepPendingIdle: "在那之前，這台伺服器只在啟動時清掃。",
      neverTitle: "永不自動結束。",
      neverHint: "它們會一直留著，直到你在這裡停掉，或是從佔著它的終端機把它結束。",
      reapHint: "沒有任何東西在用 —— 沒人連線、這麼久沒有輸出 —— 的工作階段{ended}。它的對話會保留。設成 0 就永不自動結束。",
      reapEnded: "會在伺服器下次啟動時結束",
      reapEndedSweep: "會在下次清掃時結束",
    },
    ...
    language: {
      ...
      partial: "目前只有設定畫面翻譯過了。應用程式的其餘部分仍然是英文。",
    },
  },
};
