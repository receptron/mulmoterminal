...
export const ja: Messages = {
  settings: {
    ...
    surviving: {
      ...
      doomedSoon: "次のスイープで終了",
      doomedSoonTitle: "誰も使っておらず {days} 日間出力もありません — このサーバは {hours} 時間ごとにスイープしているので、再起動を待たずに終了されます",
      open: "● 使用中",
      ...
      sweepUnit: " 時間",
      sweepHint: "このサーバでは {hours} 時間ごとに繰り返しています。",
      sweepOffTitle: "サーバ起動時のみ実行します。",
      sweepOffHint: "起動しっぱなしのサーバはその後二度と見に行きません — 繰り返すなら増やしてください。",
      sweepPendingTitle: "保存しました — 次回のサーバ起動から繰り返します。",
      sweepPendingRunning: "それまでは、このサーバは {hours} 時間ごとのスイープを続けます。",
      sweepPendingIdle: "それまでは、このサーバは起動時にしかスイープしません。",
