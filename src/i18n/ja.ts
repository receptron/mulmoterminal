...
export const ja: Messages = {
  settings: {
    ...
    surviving: {
      ...
      doomedSoonTitle: "誰も使っておらず {days} 日間出力もありません — スイープが終了させます（{hours} 時間ごとに実行）",
      open: "● 使用中",
      ...
      reapUnit: " 日",
      sweepStepper: "スイープを実行する間隔",
      sweepUnit: " 時間",
      sweepHint: "サーバが動いている間、{hours} 時間ごとにスイープします。",
      sweepOffTitle: "サーバ起動時のみ。",
      sweepOffHint: "起動しっぱなしのサーバでは何も終了しません — 稼働中もスイープするなら増やしてください。",
      sweepDisabledHint: "上でスイープ自体が無効なので、これが実行するものはありません。",
