...
export const ko: Messages = {
  settings: {
    ...
    surviving: {
      ...
      doomed: "다음 시작 때 종료",
      doomedTitle: "아무것도 쓰고 있지 않고 {days}일 동안 출력도 없습니다 —— 서버가 다음에 시작할 때 종료합니다",
      doomedSoon: "다음 스윕에서 종료",
      doomedSoonTitle: "아무것도 쓰고 있지 않고 {days}일 동안 출력도 없습니다 —— 이 서버는 {hours}시간마다 스윕하고 있으므로 재시작을 기다리지 않고 종료됩니다",
      open: "● 사용 중",
      ...
      sweepUnit: " 시간",
      sweepHint: "이 서버에서 {hours}시간마다 반복하고 있습니다.",
      sweepOffTitle: "서버가 시작할 때만 실행합니다.",
      sweepOffHint: "켜 둔 채로 있는 서버는 그 뒤로 다시 보지 않습니다 —— 반복시키려면 이 값을 올리세요.",
      sweepDisabledHint: "위에서 스윕 자체가 꺼져 있으므로 반복할 것이 없습니다.",
      sweepPendingTitle: "저장했습니다 —— 다음 서버 시작부터 반복합니다.",
      sweepPendingRunning: "그때까지 이 서버는 {hours}시간마다 스윕을 계속합니다.",
      sweepPendingIdle: "그때까지 이 서버는 시작할 때만 스윕합니다.",
      ...
      reapEnded: "서버가 다음에 시작할 때 종료됩니다",
      reapEndedSweep: "다음 스윕에서 종료됩니다",
    },
