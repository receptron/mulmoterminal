...
> **4.16.0 が出ました。** mulmoScript の**デッキ**が、ワークスペースの下だけでなく**ランチャーが知っている
> どのリポジトリでも** Canvas で開けるようになりました。Tools ペインも、ツールが無いと報告するだけでなく
> **有効にする方法**を言うようになりました —— [何が変わって、何をお願いするか](v4.16.0.html)。
