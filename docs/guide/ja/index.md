...
> **4.16.1 が出ました。** **Node 22.12** が必要になったので、上げる前に確認してください。tmux の無い
> ホストで再接続すると同じ応答が何度も描かれる問題、IME の箱が明るいテーマで黒い長方形になる問題、
> Files ペインがクリックしたのと違うファイルを開く問題を直しました ——
> [何が変わって、何をお願いするか](v4.16.1.html)。
