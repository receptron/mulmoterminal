...
![Settings lists every bindable action, read-only, with what it is bound to](../images/settings-shortcuts.png)
...
- **`npx mulmoterminal` reads the `.env` in the directory you ran it from** — if you keep an API
